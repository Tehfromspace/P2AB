...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ingetis_site_content
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ingetis_site_content');
            }

            return array (  '_controller' => 'Ingetis\\IndexBundle\\Controller\\DefaultController::indexAction',  '_route' => 'ingetis_site_content',);
        }
