...
class DemandeDoc
{
     ...
     * @var string
     *
     * @ORM\Column(name="civ", type="string", length=255, nullable=false)
     */
    private $civ;
     ...
     * @var string
     *
     * @ORM\Column(name="niveauValide", type="string", length=255, nullable=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="tFormation1", type="string", length=255, nullable=false)
     */
    private $tformation1;
     ...
     * @var string
     *
     * @ORM\Column(name="tFormation2", type="string", length=255, nullable=false)
     */
    private $tformation2;
